...
const Hero = () => {
  ...
  const [nftItemsCounter, setNftItemsCounter] = useState(0);
  const [owners, setOwners]=useState(0);
  useEffect(()=>{
    const interval = setInterval(() => {
      setNftItemsCounter((prevCounter) => (prevCounter < 546 ? prevCounter + 1 : prevCounter));
    }, 10);
  ...
  useEffect(() => {
    const intervals = setInterval(() => {
      setOwners((prevCounter) => (prevCounter < 42 ? prevCounter + 1 : prevCounter));
    }, 10);
        ...
        >
          ...
          >
            ...
            <Box>
              ...
              <Typography fontSize={{ xs: "8px" , md: "15px" }} sx={{ fontWeight: 400 }}>Owners</Typography>
            </Box>
            <hr style={{ border: "1px solid" }} />
            <Box>
              <Typography
              ...
              <Typography fontSize={{ xs: "8px",  md: "15px" }} sx={{ fontWeight: 400 }}>Items sold</Typography>
            </Box>
          </Stack>
        </Box>
        {/* left column ends*/}
